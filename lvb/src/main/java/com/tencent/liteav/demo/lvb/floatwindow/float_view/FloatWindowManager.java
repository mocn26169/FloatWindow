...
import com.tencent.liteav.demo.lvb.floatwindow.uitls.SystemUtils;
...
public class FloatWindowManager {
    ...
    private BaseFloatWindowActivity activity;
     ...
     * 显示悬浮窗口
     */
    public synchronized void showFloatWindow(BaseFloatWindowActivity baseActivity, int floatWindowType) {
    ...
    private FloatViewParams initFloatViewParams(Context mContext) {
        ...
        //根据实际宽高和设计稿尺寸比例适应。
        int marginBottom = SystemUtils.dip2px(mContext, 20);
        if (float_window_type == FW_TYPE_ROOT_VIEW) {
